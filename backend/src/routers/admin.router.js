...
const { Register,Login,SendResetOtp,VerifyResetOtp,UpdatePassword,GetAdmin,
    GetDashboard,GetUsers,GetCompany,ViewUser,ViewCompany,
    DeleteUser,DeleteCompany,Logout }= require("../controllers/admin-controller.js");
...
AdminRouter.get('/dashboard', ProtectAdminMiddleware, GetDashboard);
