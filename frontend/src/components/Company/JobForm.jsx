...
function JobForm({isEdit,handleSubmit,errors,onSubmit,isSubmitting,register,keralaDistricts,...props}) {
    const { title,location,date,time,salary,description,workersCount,district} = props
  return (
      <>
          <form
          ...
          >
              ...
              {/* Reset Form Button */}
              <button type="reset" className="text-red-500 hover:text-red-600">
                  Reset
              </button>
