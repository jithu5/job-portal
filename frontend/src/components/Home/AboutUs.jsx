...
function AboutUs() {
    return (
        <div className="w-full py-10 px-8 md:px-16 lg:px-24 bg-gray-100 my-10 md:my-20">
            <h1
                className="text-4xl md:text-5xl font-bold font-Abel text-center text-indigo-600"
            >
                About Us
            </h1>
            <p
                className="mt-6 text-lg md:text-xl text-center text-gray-700 leading-7 font-BarlowSemiCondensed"
            >
            ...
            >
                ...
                <div className="bg-white shadow-lg p-6 rounded-lg text-center w-72">
                    ...
                    <p className="mt-2 text-gray-600">
                        Gain valuable work experience while earning, preparing
